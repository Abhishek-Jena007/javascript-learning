...
console.log((Math.random()*10) + 1);// generates a random number between 1 and 11
console.log(Math.floor(Math.random()*10) + 1);// generates a random number between 1 and 10
// To generate a random number between a specific range, you can use the following formula: 
